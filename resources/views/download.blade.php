      ...
      <div class="container-fluid">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <ul>
                        <li><a class="nav-link active" aria-current="page" href="{{ url('https://drive.google.com/file/d/1_K6lU8w_fc4zGyVXMI3-Oxf_e5HRljsx/view?usp=sharing') }}">Download</a></li>
                        <li><a class="nav-link active" aria-current="page" href="{{ url('https://drive.google.com/file/d/1lPtXvopVaGXq8_nt0Zjrv8J9Z4EwUJfo/view?usp=sharing') }}">Download</a></li>
                        <li><a class="nav-link active" aria-current="page" href="{{ url('https://drive.google.com/file/d/1DGNYjkMeateVmswL7D769mg4k84Z6Jm5/view?usp=sharing') }}">Download</a></li></li>
                    </ul>
                </td>
            </tr>
        </tbody>
